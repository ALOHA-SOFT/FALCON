-- 네이버 호환 이메일 템플릿 통합 데이터 삽입 (테이블 스타일)
-- 기존 템플릿 삭제 후 새로운 템플릿 삽입
...
INSERT INTO email_templates (
  ...
  <tr>
    ...
    1,
    '네이버 호환 주문 접수 시 고객에게 발송되는 확인 이메일',
    'system',
    'system',
    NOW(),
    NOW()
