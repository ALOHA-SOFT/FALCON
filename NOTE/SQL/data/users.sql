...
-- 사용자
INSERT INTO users ( id, username, password, name, first_name, last_name, email )
VALUES ( UUID(), 'user', '$2a$12$TrN..KcVjciCiz.5Vj96YOBljeVTTGJ9AUKmtfbGpgc9hmC7BxQ92', '김사용', 'John', 'Kim','user@mail.com' );

-- 관리자
INSERT INTO users ( id, username, password, name, first_name, last_name, email )
VALUES ( UUID(), 'admin', '$2a$12$TrN..KcVjciCiz.5Vj96YOBljeVTTGJ9AUKmtfbGpgc9hmC7BxQ92', '박관리', 'David', 'Park','admin@mail.com' );


-- 테스트
INSERT INTO users ( id, username, password, name, first_name, last_name, email )
VALUES ( UUID(), 'test', '$2a$12$TrN..KcVjciCiz.5Vj96YOBljeVTTGJ9AUKmtfbGpgc9hmC7BxQ92', '이테스트', 'Michael', 'Lee','test@mail.com' );
