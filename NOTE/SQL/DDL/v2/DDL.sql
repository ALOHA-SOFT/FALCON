...
CREATE TABLE `products` (
  ...
  `category_no` bigint NULL COMMENT 'FK (카테고리)',
  `category_large_no` bigint NULL COMMENT 'FK (대분류)',
  ...
  `is_new` tinyint(1) DEFAULT 0 NULL COMMENT '신상',
  `is_best` tinyint(1) DEFAULT 0 NULL COMMENT '베스트',
  `is_sold_out` tinyint(1) DEFAULT 0 NULL COMMENT '품절',
