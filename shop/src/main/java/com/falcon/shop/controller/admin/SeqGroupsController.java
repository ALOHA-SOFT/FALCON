...
import com.falcon.shop.service.system.SeqGroupsService;
...
@Slf4j
@Controller
@RequestMapping("/admin/seqgroups")
public class SeqGroupsController {
    ...
    public String list(
        ...
        PageInfo<SeqGroups> pageInfo = seqGroupsService.page(queryParams);
        ...
        return "page/admin/seqgroups/list";
    }
    ...
    public String create() {
        return "page/admin/seqgroups/create";
    }
    ...
    public String update(@PathVariable("id") String id, Model model) {
        model.addAttribute("seqGroups", seqGroupsService.selectById(id));
        return "page/admin/seqgroups/update";
    }
}
